      ...
      <v-row>
        ...
        <v-col cols="8">
          <table style="width: 100%;">
            <tr>
              <td>
                <v-file-input class="input-file-preview" @change="previewImg" id="img1" ref="file" v-model="product.img1"></v-file-input>
    ...
    export default {
      ...
      methods: {
        postProduct: function() {
          ...
          // formData.append('img1', this.product.img1);
          // this.axios.post('product', this.product, this.$store.state.config)
